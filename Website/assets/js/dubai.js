$(document).ready(function () {
	...
	$(".animated-text-effect").typed({ 
		...
		strings: ["Dubai - where anything is possible^"], // example for multiple headings strings: ["Awesome Ineractive Effect^", "Click on the live effect!^", "Coolest Modern HTML Theme^"], 
		contentType: "text", 
		typeSpeed: 30, 
		loop: false, 
		backDelay: 1200, 
